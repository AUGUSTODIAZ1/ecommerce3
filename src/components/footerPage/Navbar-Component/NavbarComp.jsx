  ...
  return (
    <Navbar expand="lg" className="Navbar bg-tertiary" data-bs-theme="dark">
      <Container className='opacity'>
        ...
        <Navbar.Brand href="#home">Store Apple</Navbar.Brand>
        ...
        <Navbar.Collapse className='opacity'>
          ...
          <Nav className='ms-auto'>
            <Nav.Link className='btn btn-success colorSS' href="#contacto">Inciar Sessión</Nav.Link>
            <Nav.Link className='btn btn-success colorSS' href="#contacto">Registrarse</Nav.Link>
          </Nav>
          <Nav className=''>
